...
const PIECE_PATTERNS: [[u8; 3]; 32] = [
    [0, 2, 0], [2, 2, 0], [0, 3, 0], [0, 7, 0], [2, 2, 2],
    [1, 2, 0], [4, 2, 0], [1, 2, 4], [4, 2, 1], [2, 3, 0],
    [0, 3, 2], [0, 6, 2], [2, 6, 0], [1, 7, 0], [0, 7, 1],
    [4, 7, 0], [0, 7, 4], [3, 2, 2], [6, 2, 2], [2, 2, 3],
    [2, 2, 6], [2, 3, 2], [0, 7, 2], [2, 6, 2], [2, 7, 0],
    [3, 2, 3], [0, 7, 5], [6, 2, 6], [5, 7, 0], [5, 2, 5],
    [2, 7, 2], [0, 0, 0],
];
